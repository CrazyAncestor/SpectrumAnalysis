...
class SpectrumAnalysis:
    ...
    def read_hdu_data(self, hdu_id):
        hdu_raw_id, hdu_stat_id = raw_stat_hdu_name(hdu_id)
        times, E_field_avgs, E_field_stds, freqs, fft_avg_reals, fft_avg_imags, fft_stds, B_field_values, header = read_stat_hdu(self.metadata_filename, hdu_stat_id, B_field='all')
    ...
    def create_new_stat_hdu(self, hdu1_id, hdu2_id, new_hdu_id):
        
        HDU_DATA1, header1 = self.read_hdu_data(hdu1_id)
        HDU_DATA2, header2 = self.read_hdu_data(hdu2_id)

        NEW_DATA = HDU_DATA1 + HDU_DATA2
     
        write_data_to_bin_hdu(self.metadata_filename, new_hdu_id, hdu_new_type='STAT', hdu_new_header=header1, stat_data=NEW_DATA.unpack())
    
    def calculate_Ex_Ey(self, hdu1_id, hdu2_id, rot_angle_in_deg, Ex_hdu_id, Ey_hdu_id):
        ...
        write_data_to_bin_hdu(self.metadata_filename, 'STAT_' + Ex_hdu_id, hdu_new_type='STAT', hdu_new_header=header1, stat_data=Ex.unpack())
        write_data_to_bin_hdu(self.metadata_filename, 'STAT_' + Ey_hdu_id, hdu_new_type='STAT', hdu_new_header=header1, stat_data=Ey.unpack())