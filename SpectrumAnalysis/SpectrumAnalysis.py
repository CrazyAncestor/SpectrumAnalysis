...
class SpectrumAnalysis:
    ...
    def read_hdu_data(self, hdu_name):
        hdu_raw_id, hdu_stat_id = raw_stat_hdu_name(hdu_name)
    ...
    def create_new_stat_hdu(self, hdu1_id, hdu2_id, new_hdu_name):
    ...
    def calculate_Ex_Ey(self, hdu1_id, hdu2_id, rot_angle_in_deg, Ex_hdu_name, Ey_hdu_name):
